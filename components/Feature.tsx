                ...
                <div className="absolute z-20 bottom-0 left-0 top-0 right-0 h-screen bg-cover bg-center"
                    ...
                    <div className="w-full text-center mx-auto p-4">
                        ...
                        <div className="mx-auto space-x-4 w-1/2">
                            <button className="text-white px-4 py-2 text-xl font-bold rounded-xl btn2">Conferences</button>
                            <button className="text-white px-4 py-2 text-xl font-bold rounded-xl border-pink border btn3">Workshop</button>
                        ...
                        <div className="w-[90%] mx-auto mt-4 space-x-4 grid grid-cols-3">
                            <div className="bg-white/40 mx-auto space-y-1 rounded-xl p-4 items-center w-[300px]">
                                <div className="bg-pink text-center p-1 w-[90%] rounded-xl mx-auto">
                                ...
                                <button className="text-white px-4 py-3 text-lg font-bold rounded-xl btn">Read more</button>
                            </div>
                            <div className="bg-white/40 mx-auto space-y-1 rounded-xl p-4 items-center w-[300px]">
                                <div className="bg-pink text-center p-1 w-[90%] rounded-xl mx-auto">
