      ...
      <div className="flex flex-col space-y-4 pb-4 text-center sm:text-start">
        ...
        <div className="flex w-full space-x-8 items-center justify-center sm:justify-start">
          <div className="flex space-x-2 items-center">
            <span className="text-darkBlue font-medium"> 5,6</span>
          ...
          <span className="text-darkBlue font-medium">152 votes</span>
        </div>
        ...
        <div className="flex space-x-8 items-center justify-center sm:justify-start text-darkBlue">
          <div className="flex space-x-4 items-center justify-center">
            ...
            <span className='text-sm sm:text-lg font-semibold'>Dernière mise à jour 25/04/2023</span>
          </div>
          <div className="flex space-x-4 items-center justify-center">
            <svg width="25" height="25" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button className="text-yellow px-4 py-2 sm:px-8 sm:py-4 font-bold text-2xl sm:text-4xl rounded-md btn xl:text-5xl w-1/3 mx-auto sm:mx-2">Enroll</button>
      </div>
