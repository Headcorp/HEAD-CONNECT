...
export function CoursesInfo ({topics}: {topics: MyTopic[]}) {
  ...
  return (
    <div className="w-screen bg-blancsale px-20 py-4 flex-col flex space-y-4">
      <nav className="flex  py-6" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          <li className="inline-flex items-center">
            <a href="/userhome" className="inline-flex items-center text-sm font-medium text-darkBlue hover:text-blue-600 ">
          ...
          <li>
            <div className="flex items-center text-darkBlue">
              ...
              <a href="/courses" className="ml-1 text-sm font-medium text-darkBlue hover:text-blue-600 md:ml-2 ">Courses</a>
            </div>
          </li>
      ...
      <div className="flex flex-col space-y-4 w-1/2 pb-4">
        <span className="text-5xl font-extrabold text-darkBlue">
        ...
        <div className="flex space-x-8 item-center text-darkBlue">
          <div className="flex space-x-4 item-center justify-center">
            ...
            <span className='text-lg font-semibold'>Dernière mise à jour 25/04/2023</span>
          </div>
          <div className="flex space-x-4 item-center justify-center">
            <svg width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className='text-lg font-semibold'>Anglais</span>
          </div>
        </div>
        <button className="text-yellow px-4 py-2 md:px-8 md:py-4 font-bold text-2xl md:text-4xl rounded-md btn xl:text-5xl w-1/3">Enroll</button>
      </div>
      <div className="w-full p- flex flex-col space-y-4">
        <div className='w-1/2 p-4 border-2 border-darkBlue rounded-xl flex flex-col space-y-4 items-center justify-center'>
          <span className='font-bold text-2xl text-darkBlue'>Ce que vous apprenez</span>
          <div className='flex space-x-2'>
            <div className='flex flex-col space-y-2 text-start w-1/2'>
