...
export function CoursesInfo ({course, topics, channel, isStudent}: {course: google.classroom_v1.Schema$Course, topics: MyTopic[], channel: SlideChannel, isStudent: boolean}) {
  ...
  return (
    <div className="w-full lg:w-2/3 px-8 sm:px-20 py-4 flex-col flex space-y-4 mb-32 lg:mb-4">
      ...
      <div className="flex flex-col space-y-4 pb-4 text-center sm:text-start">
        ...
        <div className="flex w-full space-x-8 items-center justify-center sm:justify-start">
          <div className="flex space-x-2 items-center">
            { channel.rating_avg_stars === 0 ? null : <span className="text-darkBlue font-medium">{channel.rating_avg_stars}</span>}
            {[...Array(channel.rating_avg_stars)].map((val:any, index:number, arr) => (
          ...
          { channel.total_votes === 0 ? null : <span className="text-darkBlue font-medium">{channel.total_votes} votes</span>}
        </div>
        <span className="text-lg font-semibold text-darkBlue">
          {channel.members_count} participants
        </span>
        <div className="flex space-x-8 items-center justify-center sm:justify-start text-darkBlue">
          <div className="flex space-x-4 items-center justify-center">
            ...
            {course.updateTime ? <span className='text-sm sm:text-lg font-semibold'>Dernière mise à jour {course.updateTime?.split("T")[0]}</span>: undefined}
          </div>
          <div className="flex space-x-4 items-center justify-center">
            <svg width="25" height="25" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/*<span className='text-sm sm:text-lg font-semibold'>Anglais</span>*/}
          </div>
        </div>
      ...
      <div className="w-full flex flex-col space-y-4">
        <div className='w-full p-4 border-2 border-darkBlue rounded-xl flex flex-col space-y-4 items-center justify-center'>
          ...
          <div className='flex flex-col sm:flex-row space-x-2 space-y-2'>
            <div className='flex flex-col space-y-2 text-start sm:w-1/2'>
              <span className='flex space-x-6 items-center justify-center text-darkBlue font-semibold'>
      ...
      <div className="space-y-4">
        ...
        <ul className="">
          <li>Mac / Windows / Linux - all operating systems work with this course!</li>
          <li>No previous TensorFlow knowledge required. Basic understanding of Machine Learning is helpful</li>
        </ul>
      </div>
      <div className="space-y-4 w-full">
        <h1 className="text-2xl font-semibold text-darkBlue">Description</h1>
        <div className="space-y-2">
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem adipisci quis voluptatibus, ipsa placeat aspernatur error incidunt laborum repellendus eos maiores iste nihil, asperiores numquam itaque? Deleniti tempora suscipit possimus!</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas quas molestias iure iste, magnam aliquid mollitia, minima aliquam sit esse consequatur assumenda hic magni fugiat tenetur nostrum, dignissimos voluptatibus quasi.</p>
        </div>
      </div>
      <div className="space-y-2">
        <h2 className="text-2xl text-darkBlue font-semibold">Who this course is for:</h2>
        <ul className="">
          <li>Anyone who wants to pass the TensorFlow Developer exam so they can join Google's Certificate Network and display their certificate and badges on their resume, GitHub, and social media platforms including LinkedIn, making it easy to share their level of TensorFlow expertise with the world</li>
          <li>Students, developers, and data scientists who want to demonstrate practical machine learning skills through the building and training of models using TensorFlow</li>
          <li>Anyone looking to expand their knowledge when it comes to AI, Machine Learning and Deep Learning</li>
          <li>Anyone looking to master building ML models with the latest version of TensorFlow</li>
        </ul>
      </div>
      <div className="space-y-4 w-full">
