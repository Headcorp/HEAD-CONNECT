  ...
  return (
    <div className="w-full mx-auto flex justify-between items-center p-2"> {/* Pour fixer la navbar on rajoute : fixed top-0 z-50 bg-white */}
      <a href="/" className="w-1/4">
        <img src="../images/logo.png" alt="logo" className="ml-10 w-1/2 xl:w-4/5 hover:opacity-70" />
      </a>
      <div className="flex space-x-8 text-xl font-medium text-white items-center justify-end lg:text-2xl lg:space-x-10 xl:text-3xl w-1/2">
        <a href="#about" className="hover:underline">A Propos</a>
        <a href="#calendar" className="hover:underline">Calendrier</a>
        <a href="#pastevents" className="hover:underline">Evènements</a>
      ...
      <Menu as="div" className="flex flex-col items-center w-1/4">
        <Menu.Button className="w-full flex items-center justify-center">
          <img src="../icons/login2.svg" alt="" className="w-1/5 hover:opacity-60" />
        </Menu.Button>
