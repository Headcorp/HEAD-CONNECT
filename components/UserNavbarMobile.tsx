...
export function UserNavbarMobile() {
  ...
  return (
    <div className="w-full flex justify-between items-center p-4 userheader">
      <a href="/" className="">
        <img
          src="../images/logo.png"
          alt="logo"
          className="w-1/2 hover:opacity-60"
        />
      </a>
      <div className="" ref={navbarRef}>
        ...
        {isMobileMenuOpen && (
          <div className="navbar_mobile absolute z-50 top-30 mt-7 text-2xl font-bold right-0 w-[50%] text-center uppercase rounded-xl text-darkBlue p-8 flex flex-col justify-between space-y-2">
            <div className="flex flex-col space-y-2 text-xl font-semibold items-center sm:justify-evenly sm:flex-row">
              <a
                href=""
