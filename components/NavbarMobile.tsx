    ...
    <div className="relative mx-auto flex justify-between items-center p-4">
      ...
      <div className="flex justify-end items-center space-x-4">
        ...
        <Menu as="div" className="flex flex-col items-center">
          ...
          <Menu.Items as="div" className="flex flex-col items-center navbar_mobile absolute z-50 top-30 mt-16 text-2xl font-bold right-0 w-[50%] sm:w-[33%] text-center uppercase rounded-xl text-darkBlue p-8 space-y-4">
            {links().map((link) => (
        ...
        <div className="" ref={navbarRef}>
          ...
          {isMobileMenuOpen && (
            <div className="navbar_mobile absolute z-50 top-30 mt-2 text-2xl font-bold right-0 w-[50%] sm:w-[33%] text-center uppercase rounded-xl text-darkBlue p-8 flex flex-col justify-between">
              <div>
