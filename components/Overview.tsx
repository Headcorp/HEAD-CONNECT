    ...
    return (
        <div className="w-full flex flex-col space-y-2 text-darkBlue">
            <div className="flex flex-col space-y-4 p-6 border-b-2 border-b-darkBlue/20">
                ...
                <span className="text-lg font-medium sm:w-1/2">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</span>
            </div>
            <div className="flex p-6 border-b-2 border-b-darkBlue/20 justify-between">
            ...
            <div className="flex p-6 border-b-2 border-b-darkBlue/20 space-x-12">
                <div className="flex flex-col justify-between w-2/3">
                    <span className="text-start font-semibold text-xl">Certificate</span>
            ...
            <div className="flex p-6 border-b-2 border-b-darkBlue/20 space-x-12">
                <div className="flex flex-col justify-between w-full space-y-4">
                    <span className="text-start font-semibold text-xl">Description</span>
                    <div className="flex flex-col space-y-2 sm:space-y-4">
                        <span className="text-lg font-medium w-full sm:w-2/3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</span>
                        <span className="text-lg font-medium w-full sm:w-2/3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</span>
                        <span className="text-lg font-medium w-full sm:w-2/3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore</span>
                    </div>
                </div>
