        ...
        <div className="w-full flex space-x-10 justify-between items-center p-4 userheader">
            <a href="/" className="w-1/3 flex items-center">
                <img
                    src="/images/logo.png"
                    alt="logo"
                    className="w-1/2 xl:w-2/3 hover:opacity-60"
                />
            </a>
            {/* <a href="/userhome" className="hover:bg-pink sm:p-4 rounded-full border-4 border-pink">
            ...
            <div className="flex space-x-8 w-1/3 items-center justify-end">
