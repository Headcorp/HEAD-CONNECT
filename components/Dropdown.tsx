        ...
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
           <span className="text-xl font-bold text-white">Profil</span>
            <ChevronDownIcon
              className="ml-2 -mr-1 h-5 w-5 text-xl font-bold text-white hover:text-violet-100"
              aria-hidden="true"
            />
          </Menu.Button>
        </div>
        ...
        >
          <Menu.Items className="absolute right-0 mt-2 w-[300px] origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="w-full lg:w-2/3 rounded-xl bg-white mx-auto p-2 flex flex-col items-center space-y-4">
              ...
              <a
                href="#"
                className="text-white text-xl bg-pink rounded-xl px-8 py-4 border-pink border-4 hover:bg-white hover:text-pink font-bold"
              >
                New blog
              </a>
            </div>
